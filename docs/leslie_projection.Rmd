...
# create a sequence from 0 to 8 by a step of 1. 
time_yr <- seq(from = 0, to = 8, by = 1)

# creating an empty matrix with columns of same dimensions as initial population, and same row dimensions as length of years
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# populating the matrix with the initial conditions
